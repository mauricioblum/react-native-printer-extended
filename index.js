...
export const USBPrinter = {
  ...
  printRaw: text =>
    RNNetPrinter.printRawData(textTo64Raw(text), error => console.warn(error)),

  printText: text =>
    RNUSBPrinter.printRawData(textTo64Buffer(text), error =>
      console.warn(error)
    ),

  printBill: text =>
    RNUSBPrinter.printRawData(billTo64Buffer(text), error =>
      console.warn(error)
    )
};
